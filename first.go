...
func (x First) switch_system() {
	...
	print("")
	fmt.Println(BOLD_GREEN + "[-] " + RESET + GREEN + "Access the directory '/root'" + RESET)
	fmt.Println(BOLD_GREEN + "[-] " + RESET + GREEN + "And run './installer --second' to continue the installation" + RESET)
	press_return()
